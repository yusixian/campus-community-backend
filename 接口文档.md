...
在线接口文档地址：[校园社区后端 接口文档(apifox.cn)](https://www.apifox.cn/apidoc/shared-9459ed60-58b2-45b8-b5a8-89a63d77357f/api-12243923)
...
|is_active|query|string|false|是否激活。1或者0 1表示激活|
...
```json
{
  ...
  "result": {
    "imgPaths": [
      "http://r842fhtdz.hd-bkt.clouddn.com/f019bca1686385841ce6502635ff97ca.png",
      "http://r842fhtdz.hd-bkt.clouddn.com/83424efa54b6abc6d2e468df158bcafb.png"
    ]
  }
}
```
...
|»» isCollectioned|boolean|true|none|none|

# 发帖管理接口/管理员接口

## DELETE 批量删除回收站中文章

DELETE /articles/clear/list
...
|---|---|---|---|---|
|body|body|object|false|none|
|» type|body|string|true|支持 seq、err、out三种类型日志|
